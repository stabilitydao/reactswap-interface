import { Currency, CurrencyAmount, JSBI, Percent, Token, TradeType, Trade as V2Trade } from '@reactswap/sdk'
...
const PERMITTABLE_TOKENS: {
  ...
  [3]: {
    [SUSHI[3].address]: { type: PermitType.AMOUNT, name: 'ReactSwap' },
