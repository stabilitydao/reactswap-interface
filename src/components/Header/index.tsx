import { ChainId, Currency, NATIVE, REACT_ADDRESS, BAR_ADDRESS } from '@reactswap/sdk'
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="fixed bottom-0 left-0 z-10 flex flex-row items-center justify-center w-full p-4 lg:w-auto bg-dark-1000 lg:relative lg:p-0 lg:bg-transparent">
                  <div className="flex items-center justify-between w-full space-x-2 sm:justify-end">
                            ...
                            onClick={() => {
                              if (library && library.provider.isMetaMask && library.provider.request) {
                                ...
                                library.provider
                                  ...
                                  .then((success) => {
                                    if (success) {
                                      console.log('Successfully added xREACT to MetaMask')
                                    } else {
                    ...
                    {chainId && chainId in REACT_ADDRESS && library && library.provider.isMetaMask && (
                      <>
                        <QuestionHelper text={i18n._(t`Add REACT to your MetaMask wallet`)}>
                          <div
                            ...
                            onClick={() => {
                              const params: any = {
                                type: 'ERC20',
                                options: {
                                  address: REACT_ADDRESS[chainId],
                                  symbol: 'REACT',
                                  decimals: 18,
                                  image: 'https://stabilitydao.org/reactswap.png',
                                },
                              }
                              if (library && library.provider.isMetaMask && library.provider.request) {
                                library.provider
                                  ...
                                  .then((success) => {
                                    if (success) {
                                      console.log('Successfully added REACT to MetaMask')
                                    } else {
                                      throw new Error('Something went wrong.')
                                    }
                                  })
